...
import {getCluster} from "~/services/SessionService";
import {Connection, MostlyCloudy, Refresh, Link} from "@element-plus/icons-vue";
...
<template>
  <div class="page">
    ...
    <div v-if="cluster" class="node-container">
